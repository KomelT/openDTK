...
if [ ! -f ./data/orig/slovenia-latest.osm ]; then
  ...
  echo -e "Filtered OSM XML already exists\n"
fi
...
#####
python3 ./scripts/exportContours.py -i ./data/orig/contours/ -o ./data/out/contours
